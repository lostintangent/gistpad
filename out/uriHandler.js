...
exports.registerProtocolHandler = exports.createGistPadWebUrl = exports.createGistPadOpenUrl = void 0;
...
async function handleScratchRequest() {
    (0, utils_1.withProgress)("Opening scratch note...", async () => {
        await ensureAuthenticated();
        ...
        await (0, actions_2.newScratchNote)(false);
    });
}
