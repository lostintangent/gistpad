...
exports.initializeStorage = exports.followedUsersStorage = void 0;
...
async function initializeStorage(context) {
    ...
    _1.store.scratchNotes.show = await config.get(SHOW_SCRATCH_NOTES_KEY);
    vscode_1.workspace.onDidChangeConfiguration(async (e) => {
        if (e.affectsConfiguration(`${constants_1.EXTENSION_NAME}.${SHOW_SCRATCH_NOTES_KEY}`)) {
            _1.store.scratchNotes.show = await config.get(SHOW_SCRATCH_NOTES_KEY);
        }
    });
}
