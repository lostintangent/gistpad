...
class ScratchGistNode extends TreeNode {
    constructor(extensionContext, gist = null) {
        super("Scratch Notes", vscode_1.TreeItemCollapsibleState.Expanded);
        this.gist = gist;
        this.contextValue = "scratchGist";
        this.description = gist ? Object.keys(gist.files).length.toString() : "";
        this.iconPath = (0, utils_1.joinPath)(extensionContext, "images/scratch.svg");
    }
}
exports.ScratchGistNode = ScratchGistNode;
class NewScratchNoteNode extends TreeNode {
    constructor() {
        super("New scratch note...");
        this.command = {
            command: `${constants_1.EXTENSION_NAME}.newScratchNote`,
            title: "New scratch note..."
        };
    }
}
exports.NewScratchNoteNode = NewScratchNoteNode;
